...
import * as LayoutFlow from "../widget/layout-flow";
...
import * as LayoutFlowImpl from "./layout-flow";
...
export function register() {
    ...
    Widget.REGISTRY[LayoutFlow.WIDGET] = (props: any) => React.createElement(LayoutFlowImpl.Component, props);
